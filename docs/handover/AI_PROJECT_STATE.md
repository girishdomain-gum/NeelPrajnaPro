# AI Project State
<!-- GENERATED FILE (ADR-007). Architect hand-refresh at Sprint-2 close,
     2026-07-24 (rev 4). Developer: re-run gen_state.py in ARCH-003;
     DERIVED rows will recompute, HAND rows below are current. -->
...
| Journal | 7 records (+T0 pending); chain GREEN |
