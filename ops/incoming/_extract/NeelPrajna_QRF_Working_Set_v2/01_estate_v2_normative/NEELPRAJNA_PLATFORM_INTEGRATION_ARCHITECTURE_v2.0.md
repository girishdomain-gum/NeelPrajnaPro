...
| **Predecessors** | Constitution v2.0 · Scientific Model v2.0 · **Successor** | ARCH-011 (first sprint) |

---

## 1. The Frozen Basis

1.1 The architecture is **integration into the real, proven QRF Kernel**. NeelPrajna's research questions are judged by the instrument that closed QRF Generation 1: ten sprints, IVF-drilled, four hypotheses judged, zero promoted.
...
| Stays with NeelPrajna (NP-ADR-005 governance) | Moves to / lives in QRF |
|---|---|
...
| Supervisor/Runner trust split; autonomy ladder L0–L3; seven G-invariants | Is this window contaminated or burned? (WindowLedger) |
